...
# Dams data ---------------------------------------------------------------------------------------------
dams_NID <- readRDS(c('proc/dams_NID_hydrobasins_FFR.rds',
                      'proc/dams_NID_hydrobasins_large_FFR.rds',
                      'proc/dams_NID_hydrobasins_large2_FFR.rds',
                      'proc/dams_NID_hydrobasins_GGonly_FFR.rds')[g])
...
saveRDS(global_tab,c('proc/CI_tab_NID_FFR.rds',
                     'proc/CI_tab_NID_large_FFR.rds',
                     'proc/CI_tab_NID_large2_FFR.rds',
                     'proc/CI_tab_NID_GGonly_FFR.rds')[g])
