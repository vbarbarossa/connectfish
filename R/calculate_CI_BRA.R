...
# Dams data ---------------------------------------------------------------------------------------------
dams_NID <- readRDS(c('proc/dams_BRA_hydrobasins.rds',
                      'proc/dams_BRA_hydrobasins_large.rds',
                      'proc/dams_BRA_hydrobasins_GGonly.rds')[g])
...
saveRDS(global_tab,c('proc/CI_tab_BRA.rds',
                     'proc/CI_tab_BRA_large.rds',
                     'proc/CI_tab_BRA_GGonly.rds')[g])
